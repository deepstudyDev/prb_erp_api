package com.prb.erp.domain.log;
...
public class QErrorLog extends EntityPathBase<ErrorLog> {
    ...
    private static final long serialVersionUID = -1898150070L;

    public static final QErrorLog errorLog = new QErrorLog("errorLog");

    public final com.prb.erp.domain.QSimpleJpaModel _super = new com.prb.erp.domain.QSimpleJpaModel(this);
