package com.prb.erp.code;

public class GlobalConstants {

    public static final String DOMAIN_PACKAGE = "com.prb.erp.domain";

    public static final String LAST_NAVIGATED_PAGE = "a_x_b_l_n_p";

    public static final String ADMIN_AUTH_TOKEN_KEY = "6ad2bf4c-6543-488a-b53e-7167a5cd8a18";
