...
import com.prb.erp.domain.file.CommonFile;
import com.prb.erp.domain.file.CommonFileService;
import com.prb.erp.domain.file.UploadParameters;

@Controller
@RequestMapping(value = "/api/v1/files")
public class FileUploadController extends BaseController {
 
    @Inject private CommonFileService commonFileService;
    ...
    @RequestMapping(value="getFile", method = RequestMethod.GET, produces = APPLICATION_JSON)
    public Responses.ListResponse getFile(RequestParams<CommonFile> requestParams) { 
    	List<CommonFile> files = commonFileService.gets(requestParams);
