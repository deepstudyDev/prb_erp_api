...
import com.prb.erp.domain.init.DatabaseInitService;
...
public class InitializationController extends BaseController {
    ...
    @RequestMapping(value = "/initMember", method = RequestMethod.GET, produces = APPLICATION_JSON)
    public ApiResponse initMember() throws Exception {
        databaseInitService.initMember();
        return ok();
    }    


    @RequestMapping(value = "/initTcher", method = RequestMethod.GET, produces = APPLICATION_JSON)
    public ApiResponse initTcher() throws Exception {
        databaseInitService.initTcher();
        return ok();
    }    

    @RequestMapping(value = "/initTcher2", method = RequestMethod.GET, produces = APPLICATION_JSON)
    public ApiResponse initTcher2() throws Exception {
        databaseInitService.initTcher2();
        return ok();
    }    
